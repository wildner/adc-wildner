 ...
 */
public class TNSRuleMinerNodePlugin extends Plugin {
    // The shared instance.
    private static TNSRuleMinerNodePlugin plugin;

    /**
     * The constructor.
     */
    public TNSRuleMinerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TNSRuleMinerNodePlugin getDefault() {
        return plugin;
    }
