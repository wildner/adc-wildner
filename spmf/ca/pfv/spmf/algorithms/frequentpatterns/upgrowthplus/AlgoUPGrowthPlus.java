...
public class AlgoUPGrowthPlus {
	 ...
	 */
	private void upgrowthPlus(UPTree tree, int minUtility, int[] prefix) throws IOException {
...
loop1:		for(int i =0; i < itemset.size(); i++){
	...
	public void printStats() {
		System.out.println("=============  UP-GROWTH PLUS ALGORITHM - STATS =============");
